# Sub-Trigger-Lock Security Policy

The [latest stable release on CPAN](https://metacpan.org/release/Sub-Trigger-Lock)
...
[the Changes file on CPAN](https://metacpan.org/changes/distribution/Sub-Trigger-Lock)
